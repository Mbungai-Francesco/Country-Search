...
function App() {
  ...
  const moon = <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-moon"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path></svg>
  ...
  return (
    <>
      ...
      <div className={classer('bg-myGrey-light_gray dark:bg-myBlue-very_dark1 min-h-screen px-20 py-10 relative z-0')}>
